...
describe('compat', function () {
    describe('decode_data() / storeload', function () {
        ...
        // push a single run past mocha's default 2000ms, so give this block
        ...
        it('should decrypt a PBES2 body using the sbox declared by the container', function () {
            var pw = 'password';
            var salt = Buffer.from('31a58dc1462981189cf6c701e276c7553a5ab5f6e36d8418e4aa40c930cf3876', 'hex');
