...
const base_pb_257 = new Uint32Array([
  2868794628, 3546471302, 1984461146, 2266653769, 1477709477, 2213487392, 1124848366, 927226002, 0,
]);
...
describe("gf2m", () => {
  describe("#mod", () => {
    it("should return mod of value", () => {
      const valueA = new Uint32Array([
        0x29a65890, 0x87025056, 0x90f62ba8, 0x94aa6314, 0xde5742e1, 0x85849e20, 0xb4292849,
        0xff3ee09c, 0xa,
      ]);
      const valueP = new Uint32Array([0x00000101, 0x0000000c]);
      const expect = new Uint32Array([
        0x29a60895, 0x87025056, 0x90f62ba8, 0x94aa6314, 0xde5742e1, 0x85849e20, 0xb4292849,
        0xff3ee09c, 0,
      ]);
  ...
  describe("#inv fast", () => {
    ...
    it("should return inverted value for known PB_257 value", () => {
      ...
      const expect = new Uint32Array([
        2212782975, 784404366, 3639274527, 2383088420, 2863133559, 3083282239, 1915462745,
        2352840975, 0,
      ]);
